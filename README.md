# ![icon](data/icon.png) Jorts [NOT READY DO NOT USE IN PROD AAAAAA]
...
Most of the code was from original work by Lainsce because this is a fork of an older version of Notejot from a time before new additions broke NoteJot for elementary OS 8.
